...
type DailyIntake struct {
	DIID            string    `gorm:"primaryKey;column:DI_ID;type:varchar(20)" json:"di_id"`
	...
	CustomerUserID  string    `gorm:"column:CustomerUsers_U_ID;type:varchar(20)" json:"user_id"`
...
type Meal struct {
	MID           string `gorm:"primaryKey;column:M_ID;type:varchar(20)" json:"m_id"`
