...
const nav_links = "flex items-center justify-center text-[#FFFDF9] gap-2 hover:text-yellow-600 text-xl h-10 sm:h-12 px-4 font-bold";
...
export default function homeHeader() {
  ...
  return (
        <header className="w-full flex items-center bg-[#665944] w-full justify-between px-6 py-4">
            <div className="flex flex-row  items-center justify-between w-full">
                <Image src={"/logo/UserLogo.png"} alt="Logo" width={100} height={38} priority className="ml-15" />
                    ...
                    <div className="flex gap-4 mr-15">
                        <button onClick={handleLogout} className={`${button_styles} bg-[#FFFDF9] border-[#B2A48C] text-[#665944] hover:bg-yellow-600 hover:text-white`}>
                            Logout
                        </button>
                    </div>
                </div>
